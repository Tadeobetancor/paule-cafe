...
export const menuCategories: MenuCategory[] = [
    ...
    subgroups: [
      {
        name: "Cafés",
        products: [
          { id: "ristretto", name: "Ristretto", size: "15 ml", price: 3500, moodTags: ["intenso"] },
          { id: "espresso", name: "Espresso", size: "30 ml", price: 3500, moodTags: ["intenso"] },
          { id: "doppio", name: "Doppio", size: "60 ml", price: 4000, moodTags: ["intenso"] },
          { id: "lungo", name: "Lungo", size: "160 ml", price: 4000, moodTags: ["intenso"] },
          { id: "lagrima", name: "Lágrima", size: "160 ml", price: 3800, moodTags: ["cremoso"] },
          { id: "cortado", name: "Cortado", size: "160 ml", price: 4200, moodTags: ["cremoso"] },
          { id: "latte", name: "Latte", size: "260 ml", price: 5500, moodTags: ["cremoso"] },
          { id: "macchiato", name: "Macchiato", size: "160 ml", price: 3800, moodTags: ["intenso"] },
          { id: "americano", name: "Americano", size: "160 ml", price: 4000, moodTags: ["intenso"] },
          { id: "flat-white", name: "Flat White", size: "160 ml", price: 5600, moodTags: ["cremoso"] },
          { id: "cappuccino", name: "Cappuccino", size: "260 ml", price: 5500, moodTags: ["cremoso"] },
          { id: "cafe-con-leche", name: "Café con leche", size: "260 ml", price: 5700, moodTags: ["cremoso"] },
          {
          ...
          { id: "matcha-latte", name: "Matcha Latte", size: "260 ml", price: 6500, moodTags: ["diferente", "cremoso"] },
        ],
      },
      {
        name: "Cafés especiales",
        products: [
          { id: "bombon", name: "Bombón", size: "220 cc", price: 7400, moodTags: ["dulce", "cremoso"] },
          { id: "nuttelatte", name: "Nuttelatte", size: "343 cc", price: 8200, moodTags: ["dulce"] },
          { id: "mokaccino", name: "Mokaccino", size: "343 cc", price: 6800, moodTags: ["dulce"] },
          { id: "irlandes", name: "Irlandés", size: "170 ml", price: 6900, moodTags: ["diferente", "intenso"] },
          { id: "white-coffee", name: "White Coffee", size: "343 cc", price: 7200, moodTags: ["dulce", "cremoso"] },
          { id: "buenos-aires", name: "Buenos Aires", size: "343 cc", price: 6800, moodTags: ["diferente", "cremoso"] },
          { id: "classic", name: "Classic", size: "343 cc", price: 6300, moodTags: ["cremoso"] },
        ],
      },
    ],
  },
  {
    ...
    products: [
      { id: "iced-flat-white", name: "Iced Flat White", size: "343 ml", price: 7000, moodTags: ["frio", "cremoso"] },
      { id: "aerocano", name: "Aerocano", size: "343 cc", price: 6700, moodTags: ["frio", "intenso"] },
      { id: "cold-brew", name: "Cold Brew", size: "343 cc", price: 6700, moodTags: ["frio", "intenso"] },
      { id: "iced-classic", name: "Iced Classic", size: "343 cc", price: 6500, moodTags: ["frio", "cremoso"] },
      { id: "iced-oreo-cream", name: "Iced Oreo Cream", size: "423 ml", price: 7300, moodTags: ["frio", "dulce"] },
      { id: "iced-matcha-latte", name: "Iced Matcha Latte", size: "343 ml", price: 6800, moodTags: ["frio", "diferente"] },
    ],
  },
  {
    id: "te-en-hebras",
