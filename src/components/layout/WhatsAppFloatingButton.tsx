...
export default function WhatsAppFloatingButton() {
  return (
    <a
      ...
      className="fixed right-4 bottom-[calc(var(--mobilebar-h)+0.75rem)] z-40 flex h-14 w-14 [transform:translateZ(0)] items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_4px_10px_rgba(0,0,0,0.3),0_14px_28px_-8px_rgba(0,0,0,0.55)] transition-transform duration-200 hover:scale-105 active:scale-95 md:right-6 md:bottom-6"
    >
